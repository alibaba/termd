...
public class CompletionTest extends TestBase {
  ...
  public void testCompletion() {
    final TestTerm term = new TestTerm(this);
    term.readline(new Consumer<String>() {
      @Override
      public void accept(String s) {

      }
    }, new Consumer<Completion>() {
      @Override
  ...
  public void testEmptyCompletion() {
    ...
    Supplier<String> line = term.readlineComplete(new Consumer<Completion>() {
      @Override
      public void accept(Completion completion) {
        completion.end();
        completed.set(true);
  ...
  @Test
  public void testEmptyCompletionAsync() throws Throwable {
    TestTerm term = new TestTerm(this);
    final CompletableFuture<Completion> completed = new CompletableFuture<Completion>();
    Supplier<String> line = term.readlineComplete(new Consumer<Completion>() {
      @Override
      public void accept(Completion completion) {
  ...
  @Test
  public void testSingleTerminalCompletionAsync() throws Throwable {
    TestTerm term = new TestTerm(this);
    final CompletableFuture<Completion> completed = new CompletableFuture<Completion>();
    Supplier<String> line = term.readlineComplete(new Consumer<Completion>() {
      @Override
  ...
  public void testEmptyCompletionCollectionBlock() throws Exception {
    ...
    Supplier<String> line = term.readlineComplete(new Consumer<Completion>() {
      @Override
      public void accept(Completion completion) {
       completion.suggest(Collections.<int[]>emptyList());
       completed.set(true);
      }
    });
    term.read('a', 'b');
