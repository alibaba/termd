...
class TestTerm {
  ...
  TtyConnection conn = new TtyConnectionSupport() {
  ...
  public void readlineFail() {
    readline(new Consumer<String>() {
      @Override
      public void accept(String event) {
        readlineTest.fail("Was not accepting a call");
      }
    });
  }

  public Supplier<String> readlineComplete() {
    final AtomicReference<String> queue = new AtomicReference<String>();
    readline(new Consumer<String>() {
      @Override
      public void accept(String event) {
